...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("icon/elect113.jfif"));
        Image i3 = ic.getImage().getScaledInstance(1400, 715,Image.SCALE_DEFAULT);
...
//                Calculate Bill
        ...
        /* Third Column */
        JMenu Bill = new JMenu("Payment");
        JMenuItem u1 = new JMenuItem("Pay_Bill");
